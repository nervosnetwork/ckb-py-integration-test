...
CkbNodeConfigPath.CURRENT_TEST = CkbNodeConfigPath(
    "source/template/ckb/v210/ckb.toml.j2",
    "source/template/ckb/v210/ckb-miner.toml.j2",
    "source/template/ckb/v210/specs/dev.toml",
    "download/current",
)
...
CkbNodeConfigPath.v206 = CkbNodeConfigPath(
    "source/template/ckb/v200/ckb.toml.j2",
    "source/template/ckb/v200/ckb-miner.toml.j2",
    "source/template/ckb/v200/specs/dev.toml",
    "download/0.206.0",
...
CkbNodeConfigPath.v210 = CkbNodeConfigPath(
    "source/template/ckb/v210/ckb.toml.j2",
    "source/template/ckb/v210/ckb-miner.toml.j2",
    "source/template/ckb/v210/specs/dev.toml",
    "download/0.210.0",
